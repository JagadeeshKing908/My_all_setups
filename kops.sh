 ...
 * edit this cluster with: kops edit cluster jagadeesh.aws.k8s.local
 * edit your node instance group: kops edit ig --name=jagadeesh.aws.k8s.local nodes-ap-south-1a
 * edit your control-plane instance group: kops edit ig --name=jagadeesh.aws.k8s.local control-plane-ap-south-1a

Finally configure your cluster with: kops update cluster --name jagadeesh.aws.k8s.local --yes --admin
